...
router.get('/bilibili/user/dynamic_mstdn/:uid/:disableEmbed?', lazyloadRouteHandler('./routes/bilibili/dynamic_mstdn'));
...
router.get('/google/translate/:to/:sha/:type?/:sl?/:domain?', lazyloadRouteHandler('./routes/google/translate'));
...
// windows10spotlight
router.get('/windows10spotlight/latest', lazyloadRouteHandler('./routes/windows10spotlight/index'));
